...
setwd("C:\\Users\\AA\\Downloads\\qss-master\\qss-master\\DISCOVERY")
##loadtherawcorpus
...
##finallystemremainingwords
corpus<-tm_map(corpus,stemDocument)
##theoutputistruncatedheretosavespace
content(corpus[[10]])#EssayNo.10
...
library(wordcloud)
wordcloud(colnames(dtm.mat), dtm.mat[12, ], max.words = 20) # essay No. 1
