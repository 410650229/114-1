...
# 刪除不需要的變數
movies_final <- movies_final %>%
  select(-c(averageColorHsl, 
            criticsScore_title, 
            overlay_audienceAll_title, 
            overlay_hasAudienceAll, 
            overlay_hasAudienceVerified, 
            overlay_hasCriticsAll, 
            overlay_hasCriticsTop, 
            overlay_showScoreDetailsAudience))
